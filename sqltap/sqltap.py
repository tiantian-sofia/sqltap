...
class QueryStats(object):
    ...
    :param results: :class:`sqlalchemy.engine.CursorResult`
    ...
    def __init__(self, text, stack, start_time, end_time,
        ...
        # CursorResult.rowcount is -1 when the driver can't determine the
        # count (e.g. SELECT statements on most DBAPIs); report 0 instead
        # of a meaningless negative number.
        rowcount = getattr(results, 'rowcount', 0)
        self.rowcount = rowcount if rowcount and rowcount > 0 else 0
